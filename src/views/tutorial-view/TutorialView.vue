<template>
  <div class="flex flex-col justify-between md:flex-row h-full max-w-10/10 lg:max-w-9/10 xl:max-w-8/10">
    <div class="flex flex-col w-full justify-center items-center p-4 py-4 bg-pr">
      ...
      >
        <div class="absolute inset-0 bg-gradient-to-b from-brand-700 from-0%  to-brand-600 to-100% pointer-events-none mix-blend-multiply"></div>
        <UAlert
...
/>
    ...
    <div id="stepper-content" class="flex flex-col w-full justify-between items-center p-4 py-4 m-4 ms-0 border border-primary-500 rounded-2xl">
